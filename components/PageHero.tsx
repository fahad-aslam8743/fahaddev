...
export function PageHero({kind,eyebrow,title,body,primary,secondary}:{kind:Kind;eyebrow:string;title:string;body:string;primary?:Action;secondary?:Action}){
  ...
  return <section className={`engine-hero-section engine-page-hero engine-page-${kind}`}>
    <HeroSystem kind={kind} context={title}/>
    <div className="shell engine-hero-content">
      <Reveal className="engine-hero-copy page-hero-copy">
