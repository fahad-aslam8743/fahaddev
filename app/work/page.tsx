...
<PageHero kind="work" eyebrow="Real work. Visible thinking." title="See what was built, how the system works, and why the important decisions were made." body="Real and concept work shown as products: the problem, the interface, the connected system and the outcome it was built to support." primary={{label:'Discuss a Similar Build',href:'/contact'}} secondary={{label:'Explore Services',href:'/services'}}/>
