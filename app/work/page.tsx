...
export const metadata=pageMetadata({title:'Selected Web Development Work & Case Studies',description:'Selected commerce, dashboard and platform work showing the product problem, technical approach and business outcome behind each build.',path:'/work'});
const faqs:FAQItem[]=[
