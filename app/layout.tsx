...
export const metadata:Metadata={
  ...
  openGraph:{type:'website',locale:'en_US',url:SITE_URL,siteName:SITE_NAME,title:'FahadDev — Custom Web Development for Growing Businesses',description:DEFAULT_DESCRIPTION,images:[{url:'/heroes/home.png',width:1200,height:840,alt:'FahadDev custom web development'}]},
  twitter:{card:'summary_large_image',title:'FahadDev — Custom Web Development for Growing Businesses',description:DEFAULT_DESCRIPTION,images:['/heroes/home.png']},
...
const structuredData={
  ...
  '@graph':[
    ...
    {
      '@type':'ProfessionalService','@id':`${SITE_URL}/#business`,name:SITE_NAME,url:SITE_URL,image:`${SITE_URL}/heroes/home.png`,description:DEFAULT_DESCRIPTION,telephone:'+92-325-5504461',email:'hello@fahaddev.com',areaServed:'Worldwide',founder:{'@id':`${SITE_URL}/#fahad-aslam`},
