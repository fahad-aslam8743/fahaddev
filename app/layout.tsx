...
export const metadata:Metadata={title:{default:'Fahad — Full-Stack Developer for E-commerce & Dashboards',template:'%s — Fahad'},description:'Custom Next.js storefronts, dashboards and web apps for founders who need real engineering, not another template.'};
